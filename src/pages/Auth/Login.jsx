...
const Login = () => {
    ...
    <div className="card bg-base-100 w-full max-w-sm shrink-0 shadow-2xl">
     ...
     <h1 className="text-5xl font-bold">Login now!</h1>
        ...
        <fieldset className="fieldset">
          ...
          <button  className="btn bg-blue-300 text-white mt-4">Login</button>
        </fieldset>
        </form>
  ...
  Login with Google
         ...
         <p>Don't have a acount . <Link to={"/register"}className='text-blue-400 underline'>SignUp Now</Link> </p>
      </div>
    </div>
  </div>
</div>
